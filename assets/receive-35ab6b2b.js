import{i as y,r as N,k as T,c as v,x as l,A as w,m as u,S as h,u as f,T as k,W as $,R as A,h as R}from"./index-2e6e6c98.js";import{n as x,c as C,U as I,o as S,r as m}from"./if-defined-232c39b5.js";import"./index-7c6dc1a0.js";import"./index-abf84bc6.js";import"./index-24b14a34.js";const O=y`
  button {
    display: flex;
...
`;var d=globalThis&&globalThis.__decorate||function(c,e,r,i){var a=arguments.length,t=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,r):i,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(c,e,r,i);else for(var s=c.length-1;s>=0;s--)(o=c[s])&&(t=(a<3?o(t):a>3?o(e,r,t):o(e,r))||t);return a>3&&t&&Object.defineProperty(e,r,t),t};let n=class extends v{constructor(){super(),this.unsubscribe=[],this.address=w.state.address,this.profileName=w.state.profileName,this.network=u.state.activeCaipNetwork,this.preferredAccountType=w.state.preferredAccountType,this.unsubscribe.push(w.subscribe(e=>{e.address?(this.address=e.address,this.profileName=e.profileName,this.preferredAccountType=e.preferredAccountType):h.showError("Account not found")}),u.subscribeKey("activeCaipNetwork",e=>{e!=null&&e.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw new Error("w3m-wallet-receive-view: No account provided");const e=f.getNetworkImage(this.network);return l` <wui-flex
