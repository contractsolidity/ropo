import{v as ie,w as se,y as oe,m as U,f as ae,A as _,F as ne,B as K,G as F,H as Z,i as R,c as g,x as c,I as L,J as C,O as D,M as P,u as ce,j as ee,W as te,R as E,h as q,e as V,n as le,S as M,T as ue}from"./index-6fa2253a.js";import{n as d,c as y,o as m,r as p}from"./if-defined-9350df55.js";import{D as pe,T as de}from"./index-1aca656a.js";import"./index-6e121f62.js";import"./index-a3058540.js";import"./index-00950655.js";import"./index-4bc82079.js";import{O as Y}from"./index-30f1b0b7.js";import"./index-513c9093.js";import"./index-69c30a2d.js";import"./index-c2eb7236.js";import"./index-cd895f65.js";const N={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},H={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},he={providers:Z,selectedProvider:null,error:null,purchaseCurrency:N,paymentCurrency:H,purchaseCurrencies:[N],paymentCurrencies:[],quotesLoading:!1},l=ie(he),u={state:l,subscribe(s){return se(l,()=>s(l))},subscribeKey(s,e){return oe(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=U.state.activeChain===ae.CHAIN.SOLANA?"SOL":"USDC",t=_.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",ne),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||H,l.purchaseCurrency=s.purchaseCurrencies[0]||N,await F.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await F.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=Z,l.selectedProvider=null,l.error=null,l.purchaseCurrency=N,l.paymentCurrency=H,l.purchaseCurrencies=[N],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},me=R`
  :host {
    width: 100%;
  }
...
`;var B=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};const fe=7;let $=class extends g{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=u.state.selectedProvider,this.loading=!1,this.coinbaseTransactions=L.state.coinbaseTransactions,this.tokenImages=C.state.tokenImages,this.unsubscribe.push(u.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),()=>{clearTimeout(this.refetchTimeout)},L.subscribe(e=>{this.coinbaseTransactions={...e.coinbaseTransactions}})),L.clearCursor(),this.fetchTransactions()}render(){return c`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
        ${this.loading?this.templateLoading():this.templateTransactionsByYear()}
      </wui-flex>
    `}templateTransactions(e){return e==null?void 0:e.map(t=>{var n,j,X;const i=pe.formatDate((n=t==null?void 0:t.metadata)==null?void 0:n.minedAt),o=t.transfers[0],r=o==null?void 0:o.fungible_info;if(!r)return null;const a=((j=r==null?void 0:r.icon)==null?void 0:j.url)||((X=this.tokenImages)==null?void 0:X[r.symbol||""]);return c`
        <w3m-onramp-activity-item
          ...
          symbol=${m(r.symbol)}
        ></w3m-onramp-activity-item>
      `})}templateTransactionsByYear(){return Object.keys(this.coinbaseTransactions).sort().reverse().map(t=>{const i=parseInt(t,10);return new Array(12).fill(null).map((r,a)=>a).reverse().map(r=>{var j;const a=de.getTransactionGroupTitle(i,r),n=(j=this.coinbaseTransactions[i])==null?void 0:j[r];return n?c`
...
`;var W=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let O=class extends g{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.paymentCurrency,this.currencies=u.state.paymentCurrencies,this.currencyImages=C.state.currencyImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),C.subscribeKey("currencyImages",e=>this.currencyImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(n=D.state.features)==null?void 0:n.legalCheckbox,a=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var i;return c`
      ...
      `})}selectCurrency(e){e&&(u.setPaymentCurrency(e),P.close())}};O.styles=ge;W([p()],O.prototype,"selectedCurrency",void 0);W([p()],O.prototype,"currencies",void 0);W([p()],O.prototype,"currencyImages",void 0);W([p()],O.prototype,"checked",void 0);O=W([y("w3m-onramp-fiat-select-view")],O);const ye=R`
  button {
    padding: var(--wui-spacing-s);
    border-radius: var(--wui-border-radius-xs);
    border: none;
...
`;var A=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let v=class extends g{constructor(){super(...arguments),this.disabled=!1,this.color="inherit",this.label="",this.feeRange="",this.loading=!1,this.onClick=null}render(){return c`
    ...
    `}};v.styles=[ye];A([d({type:Boolean})],v.prototype,"disabled",void 0);A([d()],v.prototype,"color",void 0);A([d()],v.prototype,"name",void 0);A([d()],v.prototype,"label",void 0);A([d()],v.prototype,"feeRange",void 0);A([d({type:Boolean})],v.prototype,"loading",void 0);A([d()],v.prototype,"onClick",void 0);v=A([y("w3m-onramp-provider-item")],v);const be=R`
  wui-flex {
...
`;var z=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends g{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.purchaseCurrencies,this.tokens=u.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var n;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(n=D.state.features)==null?void 0:n.legalCheckbox,a=!!(e||t)&&!!i&&!this.checked;return c`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return c`
      ...
      `})}selectToken(e){e&&(u.setPurchaseCurrency(e),P.close())}};k.styles=xe;z([p()],k.prototype,"selectedCurrency",void 0);z([p()],k.prototype,"tokens",void 0);z([p()],k.prototype,"tokenImages",void 0);z([p()],k.prototype,"checked",void 0);k=z([y("w3m-onramp-token-select-view")],k);const Ce=R`
  @keyframes shake {
    0% {
...
`;var S=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let T=class extends g{constructor(){var e;super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=(e=this.currencies)==null?void 0:e[0],this.currencyImages=C.state.currencyImages,this.tokenImages=C.state.tokenImages,this.unsubscribe.push(u.subscribeKey("purchaseCurrency",t=>{!t||this.type==="Fiat"||(this.selectedCurrency=this.formatPurchaseCurrency(t))}),u.subscribeKey("paymentCurrency",t=>{!t||this.type==="Token"||(this.selectedCurrency=this.formatPaymentCurrency(t))}),u.subscribe(t=>{this.type==="Fiat"?this.currencies=t.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=t.paymentCurrencies.map(this.formatPaymentCurrency)}),C.subscribe(t=>{this.currencyImages={...t.currencyImages},this.tokenImages={...t.tokenImages}}))}firstUpdated(){u.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var i;const e=((i=this.selectedCurrency)==null?void 0:i.symbol)||"",t=this.currencyImages[e]||this.tokenImages[e];return c`<wui-input-text type="number" size="lg" value=${this.value}>
    ...
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};T.styles=Re;S([d({type:String})],T.prototype,"type",void 0);S([d({type:Number})],T.prototype,"value",void 0);S([p()],T.prototype,"currencies",void 0);S([p()],T.prototype,"selectedCurrency",void 0);S([p()],T.prototype,"currencyImages",void 0);S([p()],T.prototype,"tokenImages",void 0);T=S([y("w3m-onramp-input")],T);const Ae=R`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
...
`;var I=globalThis&&globalThis.__decorate||function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var n=s.length-1;n>=0;n--)(a=s[n])&&(r=(o<3?a(r):o>3?a(e,t,r):a(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};const Ie={USD:"$",EUR:"€",GBP:"£"},Pe=[100,250,500,1e3];let x=class extends g{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=U.state.activeCaipAddress,this.loading=P.state.loading,this.paymentCurrency=u.state.paymentCurrency,this.paymentAmount=u.state.paymentAmount,this.purchaseAmount=u.state.purchaseAmount,this.quoteLoading=u.state.quotesLoading,this.unsubscribe.push(U.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),P.subscribeKey("loading",e=>{this.loading=e}),u.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return c`
    ...
    `}templateButton(){return this.caipAddress?c`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||P.open({view:"OnRampProviders"})}openModal(){P.open({view:"Connect"})}async onPaymentAmountChange(e){u.setPaymentAmount(Number(e.detail)),await u.getQuote()}async selectPresetAmount(e){u.setPaymentAmount(e),await u.getQuote()}};x.styles=Ae;I([d({type:Boolean})],x.prototype,"disabled",void 0);I([p()],x.prototype,"caipAddress",void 0);I([p()],x.prototype,"loading",void 0);I([p()],x.prototype,"paymentCurrency",void 0);I([p()],x.prototype,"paymentAmount",void 0);I([p()],x.prototype,"purchaseAmount",void 0);I([p()],x.prototype,"quoteLoading",void 0);x=I([y("w3m-onramp-widget")],x);export{w as W3mBuyInProgressView,$ as W3mOnRampActivityView,Q as W3mOnRampProvidersView,O as W3mOnrampFiatSelectView,k as W3mOnrampTokensView,x as W3mOnrampWidget,J as W3mWhatIsABuyView};
