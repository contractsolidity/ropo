import{i as d,c as u,R as f,M as b,x as p}from"./index-6fa2253a.js";import{n as g,r as m,c as M}from"./if-defined-9350df55.js";import{T as l}from"./index-ecd9ea26.js";const R={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const r=i[0]||0,n=i[1]||0,t=e[0]||0,s=e[1]||0;return o<r?t:o>n?s:(s-t)/(n-r)*(o-r)+t}},v=d`
  :host {
    width: 100%;
    display: block;
  }
